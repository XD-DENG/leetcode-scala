...
| Leetcode # | Quiz Name | My Solution | Keywords |
|---|-----------|-------------|------------------------------|
...
|N.A.|Implement a Hash Set|[solution](https://github.com/XD-DENG/leetcode-scala/blob/master/src/MyHashSet.scala)|`Class`, `Array Concatenation`, `List Concatenation`, `contains`, `function`|
